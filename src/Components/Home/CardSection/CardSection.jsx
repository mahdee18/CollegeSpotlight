...
const CardSection = () => {
  ...
  const slicedCollegesData = collegesData.slice(0, 3);

  return (
    <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
      
    <h3 className='text-4xl font-bold text-center py-4'>Explore Fascinating Colleges</h3>

      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
      {slicedCollegesData.map((college, index) => (
          ...
          <div className="rounded-lg">
            <div className="relative flex h-60 justify-center overflow-hidden rounded-lg">
              <div className="w-full transform transition-transform duration-500 ease-in-out hover:scale-110">
                <img
                  src={college.college_image} className='h-[300px]'
                />
              </div>
            </div>
            <div className="">
              ...
              <div className="mt-2 grid grid-cols-2 grid-rows-2 gap-4 border-b border-t border-gray-200 pb-3 pt-3">
                <p className="flex items-center  text-gray-800 xl:flex-row xl:items-center">
                  ...
                  <span className="text-gray-500 text-sm">{college.admission_dates}</span>
                </p>
                <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                  <svg
                    className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
                  ...
                  <span className="mt-0 text-gray-500"> Events {college.events.length}   </span>
                </p>
                <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                  <svg
                    className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
                  ...
                  <span className="mt-0 text-gray-500">Research History   {college.research_history.length}</span>
                </p>
                <p className="flex items-center text-gray-800 xl:flex-row xl:items-center">
                  <svg
                    className="mr-3 inline-block h-5 w-5 fill-current text-gray-800 xl:h-4 xl:w-4"
                  ...
                  <span className="mt-0 text-gray-500">Sports Items {college.sports_categories.length} </span>
                </p>
              </div>
              <Link to={`/cardData/${college._id}`}>
              <button className='w-full bg-green-500 py-2 text-white font-bold'>Details</button>
